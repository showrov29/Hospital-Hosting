...
let PrescriptionsService = class PrescriptionsService {
    constructor(prescriptionReppo) {
        this.prescriptionReppo = prescriptionReppo;
    }
    getAllPrescription() {
        return this.prescriptionReppo.find();
    }
    getPrescriptionByPatientId(pid) {
...
PrescriptionsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(prescription_entity_1.PrescriptionEntity)),
